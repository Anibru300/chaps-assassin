...
const DEFAULT_STATE = {
  ...
  languages: ["Común", "Jerga de ladrones"], // +1 por Humano y +1 por Jerga (N1): añade los elegidos
  saveProfs: { str: false, dex: true, con: false, int: true, wis: false, cha: false }, // Pícaro: DES + INT
  proficiencies: ["Armadura ligera", "Armas sencillas", "Armas marciales (Sutil o Ligera)"],
  inventory: [           // {name, qty, wt (lb c/u), note}
    { name: "Mochila", qty: 1, wt: 5, note: "" },
    { name: "Flechas", qty: 20, wt: 0.05, note: "Carcaj" },
    { name: "Herramientas de ladrón", qty: 1, wt: 1, note: "" },
    { name: "Kit de disfraz", qty: 1, wt: 3, note: "" },
    { name: "Kit de envenenador", qty: 1, wt: 2, note: "" },
    { name: "Cuerda de cáñamo 50 ft", qty: 1, wt: 10, note: "" },
    { name: "Raciones", qty: 5, wt: 2, note: "" },
    { name: "Odre (lleno)", qty: 1, wt: 5, note: "" }
  ],
  skills: {
...
const WEAPON_MASTERY = [
  { id: "dagger",        es: "Daga",             en: "Dagger",         dmg: "1d4", mastery: "nick",   melee: 5, range: "20/60",  fin: true,  light: true,
  ...
  { id: "shortsword",    es: "Espada corta",     en: "Shortsword",     dmg: "1d6", mastery: "vex",    melee: 5, range: null,      fin: true,  light: true,
    propsEs: "sutil, ligera",                            propsEn: "finesse, light" },
  { id: "scimitar",      es: "Cimitarra",        en: "Scimitar",       dmg: "1d6", mastery: "nick",   melee: 5, range: null,      fin: true,  light: true,
    propsEs: "sutil, ligera",                            propsEn: "finesse, light" },
  ...
  { id: "handCrossbow",  es: "Ballesta de mano", en: "Hand Crossbow",  dmg: "1d6", mastery: "vex",    melee: 0, range: "30/120", fin: true,  light: true,
  ...
  { id: "club",          es: "Garrote",          en: "Club",           dmg: "1d4", mastery: "slow",   melee: 5, range: null,      fin: false, light: true,
    propsEs: "ligera",                                   propsEn: "light" },
  { id: "lightHammer",   es: "Martillo ligero",  en: "Light Hammer",   dmg: "1d4", mastery: "nick",   melee: 5, range: "20/60",  fin: false, light: true,
    propsEs: "ligera, arrojadiza (20/60)",               propsEn: "light, thrown (20/60)" },
  { id: "sickle",        es: "Hoz",              en: "Sickle",         dmg: "1d4", mastery: "nick",   melee: 5, range: null,      fin: false, light: true,
    propsEs: "ligera",                                   propsEn: "light" },
  { id: "handaxe",       es: "Hacha de mano",    en: "Handaxe",        dmg: "1d6", mastery: "vex",    melee: 5, range: "20/60",  fin: false, light: true,
    propsEs: "ligera, arrojadiza (20/60)",               propsEn: "light, thrown (20/60)" },
...
const I18N = {
  es: {
    ...
    languagesSection: "Idiomas", addLanguage: "+ Añadir idioma", languagePh: "Nuevo idioma…",
    languagesHint: "Humano: Común + 1 a elegir · Jerga de ladrones + 1 a elegir (N1 Pícaro). Ajusta según tus elecciones.",
    saveAbbr: "Salv.",
  ...
  en: {
    ...
    tabSheet: "Character Sheet", tabCombos: "Combo Guide",
    tabCombat: "Combat",
    ...
    toolsSection: "Tools",
    languagesSection: "Languages", addLanguage: "+ Add language", languagePh: "New language…",
    languagesHint: "Human: Common + 1 of choice · Thieves' Cant + 1 of choice (Rogue 1). Adjust to your picks.",
    saveAbbr: "Save",
